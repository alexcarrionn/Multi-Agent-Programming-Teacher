"""
Chat interactivo con el agente Evaluador.
Permite enviar tu código para que el agente lo evalúe y asigne una nota.

Ejecutar desde la carpeta code/:
    python -m tests.test_evaluador_chat
"""
import sys
import os
...
def chat():
    """Inicia una conversación interactiva con el agente Evaluador."""
    print("\n" + "=" * 60)
    print("  CHAT INTERACTIVO - AGENTE EVALUADOR")
    print("=" * 60)
    ...
    print("    codigo          -> introducir el código a evaluar")
