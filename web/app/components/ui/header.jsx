"use client";                                                                                                                                              
  ...
  // Nombres legibles para las carpetas del backend
  const ASIGNATURAS = {
            ...
            <>
              ...
              <div className="relative">
                <select
                  ...
                  className="
                    appearance-none rounded-xl border border-gray-200 bg-white/70
                    pl-4 pr-9 py-2 text-sm font-medium text-gray-700
              ...
              <Menu as="div" className="relative">
                ...
                <MenuItems
                  transition
                  className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 transition
  focus:outline-none data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[enter]:ease-out
